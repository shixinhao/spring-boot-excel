...
import site.exception.springbootexcel.bean.TestModel;
import site.exception.springbootexcel.util.FileUtil;
...
public class readExcelUtil {
    ...
    //导入excel
    @Test
    public void excelImport1() throws Exception {
        List<Object> list = new ArrayList<>();
        String route = "C:/Users/Sxh/Desktop/test/chongqing.xlsx";
        MultipartFile file = FileUtil.getMulFileByPath(route);
        list = readExcel(file,new TestModel(),1,6);
        if(list != null && list.size() > 0){
            for(Object o : list){
                TestModel xfxx = (TestModel) o;
                System.out.println(xfxx.getXm()+"/"+xfxx.getSjh()+"/"+xfxx.getSjh()+"/"+xfxx.getHaha());
            }
        }
    }
